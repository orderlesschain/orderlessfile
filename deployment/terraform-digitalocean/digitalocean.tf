...
resource "local_file" "ansible_inventory" {
  content = templatefile("../terraform-digitalocean/templates/inventory.tmpl",
    {
...
resource "local_file" "nodes_endpoints" {
  content = templatefile("../terraform-digitalocean/templates/endpoints.tmpl",
    {
      nodes-ips   = digitalocean_droplet.node[*].ipv4_address
      clients-ips = digitalocean_droplet.client[*].ipv4_address
      cli-ips     = digitalocean_droplet.cli[*].ipv4_address
...
resource "local_file" "nodes_endpoints_certificate" {
  content = templatefile("../terraform-digitalocean/templates/endpoints_certificate.tmpl",
    {
      nodes-ips   = digitalocean_droplet.node[*].ipv4_address
      clients-ips = digitalocean_droplet.client[*].ipv4_address
    })
...
resource "local_file" "nodes_endpoints_terminal" {
  content = templatefile("../terraform-digitalocean/templates/endpoints_terminals_nodes.tmpl",
    {
...
resource "local_file" "clients_endpoints_terminal" {
  content = templatefile("../terraform-digitalocean/templates/endpoints_terminals_clients.tmpl",
    {
