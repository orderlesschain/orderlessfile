...
type TransactionServiceClient interface {
	...
	ProcessProposalOrderlessFileStream(ctx context.Context, opts ...grpc.CallOption) (TransactionService_ProcessProposalOrderlessFileStreamClient, error)
	CommitOrderlessFileTransactionStream(ctx context.Context, opts ...grpc.CallOption) (TransactionService_CommitOrderlessFileTransactionStreamClient, error)
...
func (c *transactionServiceClient) ProcessProposalOrderlessFileStream(ctx context.Context, opts ...grpc.CallOption) (TransactionService_ProcessProposalOrderlessFileStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionService_ServiceDesc.Streams[1], "/protos.TransactionService/ProcessProposalOrderlessFileStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &transactionServiceProcessProposalOrderlessFileStreamClient{stream}
	return x, nil
}

type TransactionService_ProcessProposalOrderlessFileStreamClient interface {
	Send(*ProposalRequest) error
	CloseAndRecv() (*Empty, error)
	grpc.ClientStream
}

type transactionServiceProcessProposalOrderlessFileStreamClient struct {
	grpc.ClientStream
}

func (x *transactionServiceProcessProposalOrderlessFileStreamClient) Send(m *ProposalRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *transactionServiceProcessProposalOrderlessFileStreamClient) CloseAndRecv() (*Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Empty)
...
func (c *transactionServiceClient) CommitOrderlessFileTransactionStream(ctx context.Context, opts ...grpc.CallOption) (TransactionService_CommitOrderlessFileTransactionStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TransactionService_ServiceDesc.Streams[2], "/protos.TransactionService/CommitOrderlessFileTransactionStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &transactionServiceCommitOrderlessFileTransactionStreamClient{stream}
	return x, nil
}

type TransactionService_CommitOrderlessFileTransactionStreamClient interface {
	Send(*Transaction) error
	CloseAndRecv() (*Empty, error)
	grpc.ClientStream
}

type transactionServiceCommitOrderlessFileTransactionStreamClient struct {
	grpc.ClientStream
}

func (x *transactionServiceCommitOrderlessFileTransactionStreamClient) Send(m *Transaction) error {
	return x.ClientStream.SendMsg(m)
}

func (x *transactionServiceCommitOrderlessFileTransactionStreamClient) CloseAndRecv() (*Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Empty)
...
type TransactionServiceServer interface {
	...
	ProcessProposalOrderlessFileStream(TransactionService_ProcessProposalOrderlessFileStreamServer) error
	CommitOrderlessFileTransactionStream(TransactionService_CommitOrderlessFileTransactionStreamServer) error
...
func (UnimplementedTransactionServiceServer) ProcessProposalOrderlessFileStream(TransactionService_ProcessProposalOrderlessFileStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method ProcessProposalOrderlessFileStream not implemented")
}
func (UnimplementedTransactionServiceServer) CommitOrderlessFileTransactionStream(TransactionService_CommitOrderlessFileTransactionStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method CommitOrderlessFileTransactionStream not implemented")
}
...
func _TransactionService_ProcessProposalOrderlessFileStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TransactionServiceServer).ProcessProposalOrderlessFileStream(&transactionServiceProcessProposalOrderlessFileStreamServer{stream})
}

type TransactionService_ProcessProposalOrderlessFileStreamServer interface {
	SendAndClose(*Empty) error
	Recv() (*ProposalRequest, error)
	grpc.ServerStream
}

type transactionServiceProcessProposalOrderlessFileStreamServer struct {
	grpc.ServerStream
}

func (x *transactionServiceProcessProposalOrderlessFileStreamServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *transactionServiceProcessProposalOrderlessFileStreamServer) Recv() (*ProposalRequest, error) {
...
func _TransactionService_CommitOrderlessFileTransactionStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TransactionServiceServer).CommitOrderlessFileTransactionStream(&transactionServiceCommitOrderlessFileTransactionStreamServer{stream})
}

type TransactionService_CommitOrderlessFileTransactionStreamServer interface {
	SendAndClose(*Empty) error
	Recv() (*Transaction, error)
	grpc.ServerStream
}

type transactionServiceCommitOrderlessFileTransactionStreamServer struct {
	grpc.ServerStream
}

func (x *transactionServiceCommitOrderlessFileTransactionStreamServer) SendAndClose(m *Empty) error {
	return x.ServerStream.SendMsg(m)
}

func (x *transactionServiceCommitOrderlessFileTransactionStreamServer) Recv() (*Transaction, error) {
	m := new(Transaction)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ProcessProposalOrderlessFileStream",
			Handler:       _TransactionService_ProcessProposalOrderlessFileStream_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "CommitOrderlessFileTransactionStream",
			Handler:       _TransactionService_CommitOrderlessFileTransactionStream_Handler,
			ClientStreams: true,
		},
		{
